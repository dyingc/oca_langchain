...
def test_request_with_warning_control_suppresses_loopback_proxy_warning(monkeypatch):
    def fake_request(*args, **kwargs):
        warnings.warn("unverified proxy tunnel request", InsecureRequestWarning)
        return "ok"
